...
using static MobileMonetizationPro.MobileMonetizationPro_LevelPlayManager;

namespace MobileMonetizationPro
{
    [CustomEditor(typeof(MobileMonetizationPro_LevelPlayManager))]
    public class MobileMonetizationPro_LevelPlayManagerEditor : Editor
    {
        ...
        MobileMonetizationPro_LevelPlayInitializer adsInitializer;

        private void OnEnable()
        {
            adsInitializer = FindObjectOfType<MobileMonetizationPro_LevelPlayInitializer>();
        ...
        public override void OnInspectorGUI()
        {
            ...
            MobileMonetizationPro_LevelPlayManager script = (MobileMonetizationPro_LevelPlayManager)target;
            ...
            if (GUILayout.Button("SAVE THE CHANGES", GetButtonStyle(), GUILayout.Width(450), GUILayout.Height(40)))
            {
                ...
                string prefabPath = "Assets/Mobile Monetization Pro/Tools/MobileMonetization_LevelPlayManager/Prefab/MobileMonetizationPro_LevelPlayAdsManager.prefab";
                ...
                if (existingPrefab != null && PlayerPrefs.HasKey(prefabKey))
                {
                    ...
                    MobileMonetizationPro_LevelPlayManager existingPrefabScript = existingPrefab.GetComponent<MobileMonetizationPro_LevelPlayManager>();
                ...
                else
                {
                    ...
                    if (prefabAsset != null)
                    {
                        ...
                        MobileMonetizationPro_LevelPlayManager newPrefabScript = prefabAsset.GetComponent<MobileMonetizationPro_LevelPlayManager>();
